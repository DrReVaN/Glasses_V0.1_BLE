...
{
  /* DVC_INFO_SVC */
  CUSTOM_STM_DVC_FW_NR,
  CUSTOM_STM_DVC_NAME,
  /* RECEIVE_SVC */
  CUSTOM_STM_TIME_UPDATE,
  CUSTOM_STM_PUSH_NOTIFICATION,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* DVC_FW_NR */
  CUSTOM_STM_DVC_FW_NR_READ_EVT,
  /* DVC_NAME */
  CUSTOM_STM_DVC_NAME_READ_EVT,
  /* TIME_UPDATE */
  CUSTOM_STM_TIME_UPDATE_WRITE_NO_RESP_EVT,
  /* PUSH_NOTIFICATION */
  CUSTOM_STM_PUSH_NOTIFICATION_WRITE_NO_RESP_EVT,
